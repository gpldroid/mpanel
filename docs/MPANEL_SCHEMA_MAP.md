...
**Operational status:** migrations 009 and 010 are confirmed applied for the current mPanel setup. Migration 012 is the next database migration for explicit analytics retention enforcement.
